...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.businessradar.com/ext/v3/articles \\\n    -H \"Authorization: Bearer $BUSINESSRADAR_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.businessradar.com/ext/v3/articles/$ARTICLE_ID/related/ \\\n    -H \"Authorization: Bearer $BUSINESSRADAR_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.businessradar.com/ext/v3/articles/feedback/ \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $BUSINESSRADAR_API_KEY\" \\\n    -d '{\n          \"article\": \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.businessradar.com/ext/v3/saved_article_filters \\\n    -H \"Authorization: Bearer $BUSINESSRADAR_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.businessradar.com/ext/v3/articles/analytics/dates/ \\\n    -H \"Authorization: Bearer $BUSINESSRADAR_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.businessradar.com/ext/v3/articles/export/ \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $BUSINESSRADAR_API_KEY\" \\\n    -d '{\n          \"file_type\": \"PDF\",\n          \"filters\": {}\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ created_at: string; export_type: 'NEWS' | 'BINDER' | 'COMPANIES' | 'REGISTRATIONS' | 'COMPLIANCE' | 'BILLING' | 'KEY_EVENTS'; external_id: string; file_type: 'PDF' | 'EXCEL' | 'JSONL'; filters: { categories?: string[]; companies?: string[]; countries?: string[]; disable_company_article_deduplication?: boolean; duns_numbers?: string[]; global_ultimates?: string[]; include_clustered_articles?: boolean; industries?: string[]; is_material?: boolean; languages?: string[]; max_creation_date?: string; max_publication_date?: string; media_type?: 'GAZETTE' | 'MAINSTREAM'; min_creation_date?: string; min_publication_date?: string; parent_category?: string; portfolios?: string[]; query?: string; registration_numbers?: string[]; sentiment?: boolean; }; location: string; result_count: number; status: 'pending' | 'in_progress' | 'failed' | 'finished'; updated_at: string; }",
    "markdown": "## retrieve\n\n`client.news.articles.export.retrieve(external_id: string): { created_at: string; export_type: 'NEWS' | 'BINDER' | 'COMPANIES' | 'REGISTRATIONS' | 'COMPLIANCE' | 'BILLING' | 'KEY_EVENTS'; external_id: string; file_type: data_export_file_type; filters: object; location: string; result_count: number; status: 'pending' | 'in_progress' | 'failed' | 'finished'; updated_at: string; }`\n\n**get** `/ext/v3/articles/export/{external_id}`\n\n### Export Status & Details\n\nCheck the status of an ongoing export or retrieve the download link for a completed\nexport.\n\n### Parameters\n\n- `external_id: string`\n\n### Returns\n\n- `{ created_at: string; export_type: 'NEWS' | 'BINDER' | 'COMPANIES' | 'REGISTRATIONS' | 'COMPLIANCE' | 'BILLING' | 'KEY_EVENTS'; external_id: string; file_type: 'PDF' | 'EXCEL' | 'JSONL'; filters: { categories?: string[]; companies?: string[]; countries?: string[]; disable_company_article_deduplication?: boolean; duns_numbers?: string[]; global_ultimates?: string[]; include_clustered_articles?: boolean; industries?: string[]; is_material?: boolean; languages?: string[]; max_creation_date?: string; max_publication_date?: string; media_type?: 'GAZETTE' | 'MAINSTREAM'; min_creation_date?: string; min_publication_date?: string; parent_category?: string; portfolios?: string[]; query?: string; registration_numbers?: string[]; sentiment?: boolean; }; location: string; result_count: number; status: 'pending' | 'in_progress' | 'failed' | 'finished'; updated_at: string; }`\n  Data Export Serializer.\n\n  - `created_at: string`\n  - `export_type: 'NEWS' | 'BINDER' | 'COMPANIES' | 'REGISTRATIONS' | 'COMPLIANCE' | 'BILLING' | 'KEY_EVENTS'`\n  - `external_id: string`\n  - `file_type: 'PDF' | 'EXCEL' | 'JSONL'`\n  - `filters: { categories?: string[]; companies?: string[]; countries?: string[]; disable_company_article_deduplication?: boolean; duns_numbers?: string[]; global_ultimates?: string[]; include_clustered_articles?: boolean; industries?: string[]; is_material?: boolean; languages?: string[]; max_creation_date?: string; max_publication_date?: string; media_type?: 'GAZETTE' | 'MAINSTREAM'; min_creation_date?: string; min_publication_date?: string; parent_category?: string; portfolios?: string[]; query?: string; registration_numbers?: string[]; sentiment?: boolean; }`\n  - `location: string`\n  - `result_count: number`\n  - `status: 'pending' | 'in_progress' | 'failed' | 'finished'`\n  - `updated_at: string`\n\n### Example\n\n```typescript\nimport BusinessRadar from '@businessradar/businessradar';\n\nconst client = new BusinessRadar();\n\nconst articleExport = await client.news.articles.export.retrieve('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');\n\nconsole.log(articleExport);\n```",
    "perLanguage": {
      "typescript": {
      ...
      "http": {
        "example": "curl https://api.businessradar.com/ext/v3/articles/export/$EXTERNAL_ID \\\n    -H \"Authorization: Bearer $BUSINESSRADAR_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ address_place: string; address_postal: string; address_region: string; address_street: string; country: string; duns_number: string; external_id: string; industry_codes: { code: string; description: string; }[]; name: string; social_logo: string; website_icon_url: string; is_out_of_business?: boolean; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.businessradar.com/ext/v3/companies \\\n    -H \"Authorization: Bearer $BUSINESSRADAR_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ external_id: string; finished_at: string; progress: number; status: string; status_text: string; company?: { country: string; duns_number: string; external_id: string; name: string; }; country?: string; customer_reference?: string; duns_number?: string; primary_name?: string; registration_number?: string; }",
  ...
  },
  {
    ...
    "response": "{ company: string; feedback_type: string; comment?: string; notification_email?: string; trade_name?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.businessradar.com/ext/v3/companies/feedback/ \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $BUSINESSRADAR_API_KEY\" \\\n    -d '{\n          \"company\": \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\",\n          \"feedback_type\": \"NOT_ENOUGH_NEWS\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.businessradar.com/ext/v3/companies/$EXTERNAL_ID \\\n    -H \"Authorization: Bearer $BUSINESSRADAR_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.businessradar.com/ext/v3/registrations/$REGISTRATION_ID \\\n    -H \"Authorization: Bearer $BUSINESSRADAR_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.businessradar.com/ext/v3/companies/attribute_changes \\\n    -H \"Authorization: Bearer $BUSINESSRADAR_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.businessradar.com/ext/v3/companies/investigations \\\n    -H \"Authorization: Bearer $BUSINESSRADAR_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.businessradar.com/ext/v3/companies/investigations/$EXTERNAL_ID \\\n    -H \"Authorization: Bearer $BUSINESSRADAR_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.businessradar.com/ext/v3/compliance \\\n    -H \"Authorization: Bearer $BUSINESSRADAR_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.businessradar.com/ext/v3/compliance/$EXTERNAL_ID \\\n    -H \"Authorization: Bearer $BUSINESSRADAR_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.businessradar.com/ext/v3/compliance/$EXTERNAL_ID/results \\\n    -H \"Authorization: Bearer $BUSINESSRADAR_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ external_id: string; name: string; customer_reference?: string; default_permission?: 'view_only' | 'write' | 'admin' | 'owner' | ''; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.businessradar.com/ext/v3/portfolios \\\n    -H \"Authorization: Bearer $BUSINESSRADAR_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.businessradar.com/ext/v3/portfolios/$PORTFOLIO_ID/companies \\\n    -H \"Authorization: Bearer $BUSINESSRADAR_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.businessradar.com/ext/v3/portfolios/$PORTFOLIO_ID/companies/$EXTERNAL_ID \\\n    -X DELETE \\\n    -H \"Authorization: Bearer $BUSINESSRADAR_API_KEY\""
      }
    }
  }
];
