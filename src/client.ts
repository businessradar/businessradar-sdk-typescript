...
import {
  ...
  CompanyListAttributeChangesResponsesNextKey,
  CompanyListMissingCompanyInvestigationsParams,
...
export class BusinessRadar {
  ...
  constructor({
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('BUSINESS_RADAR_LOG'), "process.env['BUSINESS_RADAR_LOG']", this) ??
      defaultLogLevel;
...
export declare namespace BusinessRadar {
  ...
  export { type NextKeyParams as NextKeyParams, type NextKeyResponse as NextKeyResponse };
